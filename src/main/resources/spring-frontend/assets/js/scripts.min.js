        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">\n' +
                    ...
                    '       <a href="/books/' + book.slug + '"><img src="' + book.image + '"></a>\n' +
                    (book.discount ? '<div class="Card-sale">' + book.discount + '% скидка</div>' : '') +
                    (book.isBestseller ? '<a href="/books/' + book.slug + '"><div class="Card-ribbon"><span class="Card-ribbonText">Бестселлер</span></div></a>\n' : '') +
                    ...
                    '       <strong class="Card-title"><a href="/books/' + book.slug + '">' + book.title + '</a></strong>\n' +
                    '       <div class="Card-description"><a href="/authors/' + book.authorId + '">' + book.authors + '</a></div>\n' +
                    '       <div class="Card-cost">' +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genresroot':
                                getData('/genresroot/page/' + $this.data('refreshid'), {
                                    offset: function() {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset >= 1) {
                                            oldOffset = oldOffset - $this.data('refreshlimit');
                            ...
                            case'genres':
                                ...
                                break;
                            case'authorbooks':
                                getData('/authorbooks/page/' + $this.data('refreshid'), {
                                    offset: function() {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset >= 1) {
                                            oldOffset = oldOffset - $this.data('refreshlimit');
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/bookReview', {
                                ...
                                userName: $this.find('#reviewAuthor').val(),
                                text: $this.find('#reviewText').val()
                            }, function (result) {
                                if (result.result) {
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">Пользователь не найден или неверный пароль</div>');
                                        }
                                    }
                                })
                            }
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/' + $(this).data("bookid") + '/rating', {
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case 'recommended':
                                                sendData('/recommended/page')
                                                break;
                                            case 'recent':
                                                sendData('/recent/page')
                                                break;
                                            case 'popular':
                                                sendData('/popular/page')
                                                break;
                                            case 'author':
                                                sendData('/authorbooks/page/' + $(slick.$slider).data('refreshid'))
                                                break;
                                        }
                                    }
                                }
